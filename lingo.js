  ...
  var pressn = 1; 
	...
	input.onkeypress = function(event) {
		if (event.key == "Enter" || event.keyCode == 13) {
		  document.getElementById('msg').innerHTML = "Green = correct letter, Yellow = wrong place but correct letter"; // reset message
		  guess = input.value;
		  ...
		  if(guess.length !== 5){
			document.getElementById('msg').innerHTML = "Guess must be 5 letters!";
			if(pressn===5){
			  end("you lost.", "Correct word was: " + rand);
			}
			pressn++;
